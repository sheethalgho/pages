...
import noappointments from "../../patient-profile/assets/noappointments.png";
...
const AppointmentCard = () => {
  ...
  return (
    <div className="w-full border border-gray-400 rounded-sm overflow-hidden">
      ...
      <div
        className={`p-4 bg-white rounded-b-lg h-52 ${
        ...
        {appointments.length === 0 ? (
          <>
            <Image
              ...
              height={100}
            />
            <p className="text-gray-500 text-sm mt-2">No appointments found</p>
          </>
        ) : (
